...
public static class ImageHandler
{
  ...
  public static void CreateDefaultImages(string appDataPath)
  {
    ...
    CreatePlaceholderImage(thumbnailSize.Width, thumbnailSize.Height, System.Drawing.Color.Gray, "Thumbnail", thumbnailPath);
    CreatePlaceholderImage(mediumSize.Width, mediumSize.Height, System.Drawing.Color.LightGray, "Medium", mediumPath);
    CreatePlaceholderImage(highResSize.Width, highResSize.Height, System.Drawing.Color.DarkGray, "High Res", highResPath);

  }


  private static void CreatePlaceholderImage(int width, int height, System.Drawing.Color backgroundColor, string text, string filePath)
  {
